            ...
            <div className="footer-content">
                <div className="footer-top">
                    <div className="footer-action">
                        <Button text="Contact Us" imageSrc="/src/assets/brown-button-icon.png" />
                        <img src="src/assets/brownlogo4.png" alt="Brown AI Logo" className='footer-logo1'/>
                    </div>
                ...
                <div className="footer-bottom">
                    ...
                    <p className='footer-copy'>Design inspired by Y Comibator's <a target='_blank' href='https://ycombinator.com'>website</a>.</p>
