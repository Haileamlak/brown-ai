            ...
            <div className="footer-content">
                <div className="footer-top">
                    <div className="footer-action">
                        ...
                        <img src="./assets/brownlogo4.png" alt="Bunama AI Logo" className='footer-logo1' />
                    </div>
                    ...
                    <div className="footer-contact">
                        <h3>Contact Info</h3>
                        <p><span style={{ fontWeight: 'bold' }}>Email:</span> <a href="mailto:bunama.ai@gmail.com">bunama.ai@gmail.com</a></p>
                        {/* <p><span style={{ fontWeight: 'bold' }}>Phone:</span> <a href="tel:+251906397248">+251 906 397 248</a></p> */}
                        <p><span style={{ fontWeight: 'bold' }}>Address:</span> Bunama AI St, AI City, AI Country</p>
                    </div>
                    <img src="./assets/brownlogo4.png" alt="Bunama AI Logo" className='footer-logo2' width={200} />

                </div>
                <div className="footer-bottom">
                    <p className='footer-copy'>&copy; {new Date().getFullYear()} Bunama AI. All rights reserved.</p>
